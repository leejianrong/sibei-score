...
> migration fixture test, (V8e) the container, (V8f) the docs. **V8a and V8b are done** — V8b
...
> follow in a later sub-slice rather than as dead code in the package's own PR. Two corrections
